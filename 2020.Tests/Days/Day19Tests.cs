...
{
    public class Day19Tests : BaseDayTests<Day19>
    {
        public Day19Tests(ITestOutputHelper testOutputHelper) : base(testOutputHelper, new Day19())
        {
        }

        [Theory]
        [BulkFileData("TestCases/Day19_TestCasePack.txt")]
